...
# ----------------------------------------
# If PLLCONF_HDMI is one of several IP cores in your
...
# ----------------------------------------
# ACDS 16.0 211 win32 2016.11.13.21:42:05
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "PLLCONF_HDMI"
}
...
ensure_lib              ./libraries/PLLCONF_HDMI/
vmap       PLLCONF_HDMI ./libraries/PLLCONF_HDMI/
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_pll_reconfig/altera_pll_reconfig_top.v"  -work PLLCONF_HDMI
  eval  vlog $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/altera_pll_reconfig/altera_pll_reconfig_core.v" -work PLLCONF_HDMI
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/PLLCONF_HDMI.vhd"                                                 
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L PLLCONF_HDMI -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L PLLCONF_HDMI -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev $TOP_LEVEL_NAME
}
