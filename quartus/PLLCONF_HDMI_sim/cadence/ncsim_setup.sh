...
mkdir -p ./libraries/PLLCONF_HDMI/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/altera_pll_reconfig/altera_pll_reconfig_top.v"  -work PLLCONF_HDMI -cdslib ./cds_libs/PLLCONF_HDMI.cds.lib
  ncvlog $USER_DEFINED_COMPILE_OPTIONS      "$QSYS_SIMDIR/altera_pll_reconfig/altera_pll_reconfig_core.v" -work PLLCONF_HDMI -cdslib ./cds_libs/PLLCONF_HDMI.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/PLLCONF_HDMI.vhd"                                                                                         
fi
