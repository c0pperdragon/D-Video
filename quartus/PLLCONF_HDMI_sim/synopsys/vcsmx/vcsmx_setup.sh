...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/altera_pll_reconfig/altera_pll_reconfig_top.v"  -work PLLCONF_HDMI
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS  "$QSYS_SIMDIR/altera_pll_reconfig/altera_pll_reconfig_core.v" -work PLLCONF_HDMI
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/PLLCONF_HDMI.vhd"                                                 
fi
